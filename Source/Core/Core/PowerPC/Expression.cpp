...
static std::array<expr_func, 23> g_expr_funcs{{
    ...
    {"read_u8", HostReadFunc<u8>, nullptr, 0},
    {"read_s8", HostReadFunc<s8, u8>, nullptr, 0},
    {"read_u16", HostReadFunc<u16>, nullptr, 0},
    {"read_s16", HostReadFunc<s16, u16>, nullptr, 0},
    {"read_u32", HostReadFunc<u32>, nullptr, 0},
    {"read_s32", HostReadFunc<s32, u32>, nullptr, 0},
    {"read_f32", HostReadFunc<float, u32>, nullptr, 0},
    {"read_f64", HostReadFunc<double, u64>, nullptr, 0},
    {"write_u8", HostWriteFunc<u8>, nullptr, 0},
    {"write_u16", HostWriteFunc<u16>, nullptr, 0},
    {"write_u32", HostWriteFunc<u32>, nullptr, 0},
    {"write_f32", HostWriteFunc<float, u32>, nullptr, 0},
    {"write_f64", HostWriteFunc<double, u64>, nullptr, 0},
    {"u8", CastFunc<u8>, nullptr, 0},
    {"s8", CastFunc<s8, u8>, nullptr, 0},
    {"u16", CastFunc<u16>, nullptr, 0},
    {"s16", CastFunc<s16, u16>, nullptr, 0},
    {"u32", CastFunc<u32>, nullptr, 0},
    {"s32", CastFunc<s32, u32>, nullptr, 0},
    {"callstack", CallstackFunc, nullptr, 0},
    {"streq", StreqFunc, nullptr, 0},
    {},
}};
